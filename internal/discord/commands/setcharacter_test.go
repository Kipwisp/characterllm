...
func TestSetCharacterCmd_EchoesLastMessage(t *testing.T) {
	...
	cmdCtx.Session.SaveMessage(context.Background(), guildID, "1", llm.RoleUser, "hi")
	cmdCtx.Session.SaveMessage(context.Background(), guildID, "1", llm.RoleAssistant, "Hello, it's me.")
